...
<p>Looking to further your studies and take up a built environment related course? Check out the list of courses and work-study programmes from local Institutions of Higher Learning below.</p>
<ul data-tight="true" class="tight">
  <li>
    <p>
      <a href="#full-time-uni" rel="noopener noreferrer nofollow" target="_self">Full-time University Courses</a>
    </p>
  </li>
  <li>
    <p>
      <a href="#full-time-poly" rel="noopener noreferrer nofollow" target="_self">Full-time Polytechnic Courses</a>
    </p>
  </li>
  <li>
    <p>
      <a href="#full-time-ite" rel="noopener noreferrer nofollow" target="_self">Full-time ITE Courses</a>
    </p>
  </li>
</ul>
